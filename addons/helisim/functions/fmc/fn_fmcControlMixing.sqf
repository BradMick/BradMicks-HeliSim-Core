...
private _pedalInput = _heli getVariable "bmkhs_pedalLeftRight";
private _pedalTrim  = _heli getVariable "bmkhs_forceTrimPosYaw";
private _pedalOut   = _pedalInput + _pedalTrim;
private _collOut    = _heli getVariable "bmkhs_collectiveOutput";
/////////////////////////////////////////////////////////////////////////////////////////////
// Collective To Pitch  /////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
...
private _collToPitch = [_collToPitchTable, _collOut] call bmkhs_fnc_mathLinearInterp select 1;
...
private _collToRoll = [_collToRollTable, _collOut] call bmkhs_fnc_mathLinearInterp select 1;
/*
SPD_TBL =
[
 [  0.00, 1.00] //0kts
...
_collToRoll = _collToRoll * ([_speedToRollTable, _gndSpeed] call bmkhs_fnc_mathLinearInterp select 1);
...
private _yawToPitch = [_yawToPitchTable, _pedalOut] call bmkhs_fnc_mathLinearInterp select 1;
...
private _yawToRoll = ([_yawToRollTable, _pedalOut] call bmkhs_fnc_mathLinearInterp select 1) * 0.6;
