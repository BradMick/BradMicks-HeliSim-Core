/* ----------------------------------------------------------------------------
Function: bmkhs_fnc_rotorFlapDynamics
...
private _flapMoments   = (_heli getVariable "bmkhs_rotorFlapMoment")   select _rotorIndex;
private _bladeAzimuths = (_heli getVariable "bmkhs_rotorBladeAzimuth") select _rotorIndex;
private _M0   = 0.0;
private _Mlat = 0.0;
private _Mlon = 0.0;
...
[_heli, "bmkhs_rotorBeta0Target", _rotorIndex, _beta0Target] call bmkhs_fnc_utilSetArrayVariable;
[_heli, "bmkhs_rotorA1Target",    _rotorIndex, _a1Target]    call bmkhs_fnc_utilSetArrayVariable;
[_heli, "bmkhs_rotorB1Target",    _rotorIndex, _b1Target]    call bmkhs_fnc_utilSetArrayVariable;
...
[_heli, "bmkhs_rotorBeta0", _rotorIndex, _beta0] call bmkhs_fnc_utilSetArrayVariable;
[_heli, "bmkhs_rotorA1",    _rotorIndex, _a1]    call bmkhs_fnc_utilSetArrayVariable;
[_heli, "bmkhs_rotorB1",    _rotorIndex, _b1]    call bmkhs_fnc_utilSetArrayVariable;
