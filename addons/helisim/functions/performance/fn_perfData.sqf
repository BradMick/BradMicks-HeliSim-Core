...
// Base Data        /////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
private _perfTable0 = [getArray (_config >> "perfTable0"), _pa] call bmkhs_fnc_mathLinearInterp;
private _perfTable1 = [getArray (_config >> "perfTable1"), _pa] call bmkhs_fnc_mathLinearInterp;
private _perfTable2 = [getArray (_config >> "perfTable2"), _pa] call bmkhs_fnc_mathLinearInterp;
private _perfTable3 = [getArray (_config >> "perfTable3"), _pa] call bmkhs_fnc_mathLinearInterp;
private _perfTable4 = [getArray (_config >> "perfTable4"), _pa] call bmkhs_fnc_mathLinearInterp;
...
// Hover Data       /////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
private _hoverTable0 = [getArray (_config >> "hoverTable0"), _pa] call bmkhs_fnc_mathLinearInterp;
private _hoverTable1 = [getArray (_config >> "hoverTable1"), _pa] call bmkhs_fnc_mathLinearInterp;
private _hoverTable2 = [getArray (_config >> "hoverTable2"), _pa] call bmkhs_fnc_mathLinearInterp;
private _hoverTable3 = [getArray (_config >> "hoverTable3"), _pa] call bmkhs_fnc_mathLinearInterp;
private _hoverTable4 = [getArray (_config >> "hoverTable4"), _pa] call bmkhs_fnc_mathLinearInterp;
...
private _intHoverTable = [_hoverTable, _fat] call bmkhs_fnc_mathLinearInterp;
 //----------------------|-GWT-0-|-------IGE-1---------------OGE-2-------|
...
/////////////////////////////////////////////////////////////////////////////////////////////
//-40 deg C
private _cruiseTable00 = [getArray (_config >> "cruiseTable00"), _pa] call bmkhs_fnc_mathLinearInterp;    //15000lbs
private _cruiseTable01 = [getArray (_config >> "cruiseTable01"), _pa] call bmkhs_fnc_mathLinearInterp;    //17000lbs
private _cruiseTable02 = [getArray (_config >> "cruiseTable02"), _pa] call bmkhs_fnc_mathLinearInterp;    //19000lbs
private _cruiseTable03 = [getArray (_config >> "cruiseTable03"), _pa] call bmkhs_fnc_mathLinearInterp;    //21000lbs
...
private _intCruiseTable0 = [_cruiseTable0_GWT, _curGWT_kg] call bmkhs_fnc_mathLinearInterp;
//-20 deg C
private _cruiseTable10 = [getArray (_config >> "cruiseTable10"), _pa] call bmkhs_fnc_mathLinearInterp;    //15000lbs
private _cruiseTable11 = [getArray (_config >> "cruiseTable11"), _pa] call bmkhs_fnc_mathLinearInterp;    //17000lbs
private _cruiseTable12 = [getArray (_config >> "cruiseTable12"), _pa] call bmkhs_fnc_mathLinearInterp;    //19000lbs
private _cruiseTable13 = [getArray (_config >> "cruiseTable13"), _pa] call bmkhs_fnc_mathLinearInterp;    //21000lbs
//---------------------------|-GWT-0-|-------20kts-1-----|-------40kts-2-----|-------60kts-3-----|-------90kts-4-----|------120kts-5-----|------140kts-6-----|
...
private _intCruiseTable1 = [_cruiseTable1_GWT, _curGWT_kg] call bmkhs_fnc_mathLinearInterp;
//  0 deg C
private _cruiseTable20 = [getArray (_config >> "cruiseTable20"), _pa] call bmkhs_fnc_mathLinearInterp;    //15000lbs
private _cruiseTable21 = [getArray (_config >> "cruiseTable21"), _pa] call bmkhs_fnc_mathLinearInterp;    //17000lbs
private _cruiseTable22 = [getArray (_config >> "cruiseTable22"), _pa] call bmkhs_fnc_mathLinearInterp;    //19000lbs
private _cruiseTable23 = [getArray (_config >> "cruiseTable23"), _pa] call bmkhs_fnc_mathLinearInterp;    //21000lbs
//---------------------------|-GWT-0-|-------20kts-1-----|-------40kts-2-----|-------60kts-3-----|-------90kts-4-----|------120kts-5-----|------140kts-6-----|
...
private _intCruiseTable2 = [_cruiseTable2_GWT, _curGWT_kg] call bmkhs_fnc_mathLinearInterp;
// 20 deg C
private _cruiseTable30 = [getArray (_config >> "cruiseTable30"), _pa] call bmkhs_fnc_mathLinearInterp;    //15000lbs
private _cruiseTable31 = [getArray (_config >> "cruiseTable31"), _pa] call bmkhs_fnc_mathLinearInterp;    //17000lbs
private _cruiseTable32 = [getArray (_config >> "cruiseTable32"), _pa] call bmkhs_fnc_mathLinearInterp;    //19000lbs
private _cruiseTable33 = [getArray (_config >> "cruiseTable33"), _pa] call bmkhs_fnc_mathLinearInterp;    //21000lbs
//---------------------------|-GWT-0-|-------20kts-1-----|-------40kts-2-----|-------60kts-3-----|-------90kts-4-----|------120kts-5-----|------140kts-6-----|
...
private _intCruiseTable3 = [_cruiseTable3_GWT, _curGWT_kg] call bmkhs_fnc_mathLinearInterp;
// 40 deg C
private _cruiseTable40 = [getArray (_config >> "cruiseTable40"), _pa] call bmkhs_fnc_mathLinearInterp;    //15000lbs
private _cruiseTable41 = [getArray (_config >> "cruiseTable41"), _pa] call bmkhs_fnc_mathLinearInterp;    //17000lbs
private _cruiseTable42 = [getArray (_config >> "cruiseTable42"), _pa] call bmkhs_fnc_mathLinearInterp;    //19000lbs
private _cruiseTable43 = [getArray (_config >> "cruiseTable43"), _pa] call bmkhs_fnc_mathLinearInterp;    //21000lbs
//---------------------------|-GWT-0-|-------20kts-1-----|-------40kts-2-----|-------60kts-3-----|-------90kts-4-----|------120kts-5-----|------140kts-6-----|
...
private _intCruiseTable4 = [_cruiseTable4_GWT, _curGWT_kg] call bmkhs_fnc_mathLinearInterp;
...
private _cruiseTable = [_cruiseTable_FAT, _fat] call bmkhs_fnc_mathLinearInterp;
//Set cruise table
/////////////////////////////////////////////////////////////////////////////////////////////
// TAS Data         /////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
private _TASTable0 = [getArray (_config >> "TASTable0"), _pa] call bmkhs_fnc_mathLinearInterp;    //-40 deg C
private _TASTable1 = [getArray (_config >> "TASTable1"), _pa] call bmkhs_fnc_mathLinearInterp;    //-20 deg C
private _TASTable2 = [getArray (_config >> "TASTable2"), _pa] call bmkhs_fnc_mathLinearInterp;    //  0 deg C
private _TASTable3 = [getArray (_config >> "TASTable3"), _pa] call bmkhs_fnc_mathLinearInterp;    // 20 deg C
private _TASTable4 = [getArray (_config >> "TASTable4"), _pa] call bmkhs_fnc_mathLinearInterp;    // 40 deg C
